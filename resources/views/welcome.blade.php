   ...
   <section class="howsection">
        <div class="howsection_content">
            <div class="howsection-card">
                ...
                <p>Fale sobre o destino, datas, estilo de viagem, quem vai com você e o que não pode faltar na experiência.</p>
            </div>
            <div class="howsection-card">
                <h1>🧩 2º passo — Deixe a IA montar tudo pra você</h1>
                <p>Com base nas suas preferências, criamos um roteiro completo com hospedagem, passeios, restaurantes e dicas imperdíveis.</p>
            </div>
            <div class="howsection-card">
                <h1>📅 3º passo — Receba um roteiro sob medida, pronto pra usar</h1>
                <p>Visualize e leve com você um plano de viagem personalizado, prático e feito especialmente para o seu jeito de viajar.</p>
            </div>
        </div>
    </section>
